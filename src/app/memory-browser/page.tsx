...
export default function MemoryBrowser() {
  const [activePlugin, setActivePlugin] = useState("windows.pslist");

  return (
    <div className="app pt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
      ...
      <div className="filter-bar" style={{ display: 'flex', gap: 10, marginBottom: 14 }}>
        ...
        >
          <option value="windows.pslist">Plugin: windows.pslist</option>
          <option value="windows.malfind">Plugin: windows.malfind</option>
        </select>
      </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: 'var(--mono)', fontSize: 12 }}>
          <thead>
            <tr>
              ...
              <th style={{ textAlign: 'left', fontSize: 10, letterSpacing: 1, textTransform: 'uppercase', color: 'var(--text-tertiary)', padding: '10px 14px', borderBottom: '1px solid var(--border)', background: 'var(--bg-raised)' }}>ImageFileName</th>
              ...
              <th style={{ textAlign: 'left', fontSize: 10, letterSpacing: 1, textTransform: 'uppercase', color: 'var(--text-tertiary)', padding: '10px 14px', borderBottom: '1px solid var(--border)', background: 'var(--bg-raised)' }}>SessionId</th>
              <th style={{ textAlign: 'left', fontSize: 10, letterSpacing: 1, textTransform: 'uppercase', color: 'var(--text-tertiary)', padding: '10px 14px', borderBottom: '1px solid var(--border)', background: 'var(--bg-raised)' }}>CreateTime</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>4</td>
              ...
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>0x000000000000</td>
              ...
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>2026-07-06 14:00:00</td>
            </tr>
            <tr>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>312</td>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>4</td>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>smss.exe</td>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>0x0000020A1000</td>
              ...
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>0</td>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>2026-07-06 14:00:05</td>
            </tr>
            <tr className="flagged selected" style={{ background: 'rgba(157,0,255,0.06)', outline: '1px solid var(--red)', outlineOffset: -1 }}>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-primary)', whiteSpace: 'nowrap' }}><span className="badge-flag" style={{ display: 'inline-block', width: 6, height: 6, borderRadius: '50%', background: 'var(--red)', marginRight: 8 }}></span>666</td>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>500</td>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>svchost.exe</td>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>0x0000020B4C00</td>
              ...
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>2026-07-06 14:22:05</td>
            </tr>
            <tr>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>704</td>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>500</td>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>lsass.exe</td>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>0x0000020A8000</td>
              ...
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>0</td>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>2026-07-06 14:00:10</td>
            </tr>
            <tr className="flagged" style={{ background: 'rgba(157,0,255,0.06)' }}>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-primary)', whiteSpace: 'nowrap' }}><span className="badge-flag" style={{ display: 'inline-block', width: 6, height: 6, borderRadius: '50%', background: 'var(--red)', marginRight: 8 }}></span>1337</td>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>666</td>
              ...
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>0x0000010A1000</td>
              ...
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>1</td>
              <td style={{ padding: '8px 14px', borderBottom: '1px solid var(--border-soft)', color: 'var(--text-primary)', whiteSpace: 'nowrap' }}>2026-07-06 14:22:15</td>
            </tr>
          </tbody>
        </table>
      </div>

      {activePlugin === "windows.malfind" && (
        <div className="detail-panel" style={{ marginTop: 16, border: '1px solid var(--border)', borderRadius: 10, background: 'var(--bg-surface)', padding: '18px 20px' }}>
          <p className="detail-title" style={{ fontSize: 11, letterSpacing: 1.5, textTransform: 'uppercase', color: 'var(--text-tertiary)', margin: '0 0 14px' }}>Process 666 — malfind detail</p>
      ...
      <div className="footer-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 20 }}>
        ...
        <Link href="/workspace" style={{ textDecoration: 'none' }}>
          <button style={{ fontFamily: 'var(--sans)', fontSize: 12, padding: '7px 16px', background: 'transparent', color: 'var(--text-secondary)', border: '1px solid var(--border)', borderRadius: 7, cursor: 'pointer' }}>← Back to AI Review</button>
        </Link>
      </div>
